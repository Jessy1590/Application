...
async function verifierSecurite(siteId, options = {}) {
  ...
  // Storage cookies = même session que le hub Next (@supabase/ssr)
  const authOpts = {
    flowType: 'pkce',
    detectSessionInUrl: true,
    persistSession: true,
  };
  if (typeof window !== 'undefined' && window.SupabaseCookieStorage) {
    authOpts.storage = window.SupabaseCookieStorage;
  }

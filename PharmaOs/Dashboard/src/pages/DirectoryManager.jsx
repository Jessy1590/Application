...
import { LogOut, ArrowLeft, Users, Plus, Phone, Edit, Trash2, Filter } from 'lucide-react';
import { fetchContacts, deleteContact } from '../services/directoryService';
...
export default function DirectoryManager({ onNavigate }) {
  ...
  const [filterType, setFilterType] = useState('all'); // 'all' | 'health_professional' | 'commercial_partner'
    ...
    <div className="min-h-screen bg-slate-100">
      <header className="bg-white border-b border-slate-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <button
            onClick={signOut}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-50 text-sm transition-colors"
          >
            <LogOut size={14} />
            Déconnexion
          </button>

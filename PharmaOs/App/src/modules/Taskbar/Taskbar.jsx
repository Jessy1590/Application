...
import {
  ...
  ShieldAlert, ClipboardCheck, BookMarked, Package, PackageX, BedDouble, Scale,
  AlertOctagon, FlaskConical, Droplets, Wallet,
} from 'lucide-react';
import { useAuth } from '../../core/AuthContext.jsx';
import { supabase } from '../../services/supabaseClient';
import {
  expandWindow, reduceWindow, openModuleWindow,
...
export default function Taskbar() {
  ...
  // En mode réduit, Electron redimensionne la fenêtre à une pastille (plus de bande pleine largeur).
  ...
  return (
    <div className="w-full h-full flex items-center justify-between px-2 bg-slate-900/90 text-white">
      <div className="flex items-center gap-0.5 min-w-0 overflow-x-auto">
        ...
        <TbBtn title="Contrôles qualité" onClick={open('controls')} className="text-teal-400"><ClipboardCheck size={18} /></TbBtn>

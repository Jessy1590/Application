...
import { openModuleWindow } from '../../services/windowService';
import { 
...
export default function Directory() {
  ...
  // UI State
  const [activeTab, setActiveTab] = useState('health_professional'); // 'health_professional' | 'commercial_partner'
  ...
  const fetchContacts = async () => {
    try {
      setLoading(true);
      // Règle stricte : On cible uniquement le schéma PharmaOs

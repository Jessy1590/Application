...
// Ecran plein-cadre affiche quand l'utilisateur n'est pas authentifie.
// Utilise supabase.auth via useAuth() (src/core/AuthContext.jsx).
export default function Login() {
  ...
  const handleSubmit = async (event) => {
    ...
    // Succes : onAuthStateChange (dans AuthContext) met a jour la session,
    // App.jsx bascule automatiquement vers <Taskbar />.
  };
